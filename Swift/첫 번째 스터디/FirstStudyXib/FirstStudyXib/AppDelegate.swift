...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        tabbarController.viewControllers = [firstNavigationVC, secondNavigationVC]
        
        let item1 = UITabBarItem(title: "첫 번째", image: nil, tag: 0)
        let item2 = UITabBarItem(title: "두 번째", image: nil, tag: 1)
        
        firstNavigationVC.tabBarItem = item1
        secondNavigationVC.tabBarItem = item2
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "FirstStudyXib")
